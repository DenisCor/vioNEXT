    ...
    return (
        ...
        >
            <div className="modal-content overflow-hidden">
                <div className="row no-gutters justify-content-center position-relative">
                        ...
                        <div className="row no-gutters bg-white newsletter-popup-content">
                            <div className="col-xl-3-5col col-lg-7 banner-content-wrap">
                                ...
                                <div className="banner-content text-center">
                                    ...
                                    <h2 className="banner-title">get <span>25<span style={ { fontWeight: '400' } } className="ml-3">%</span></span> off</h2>
                                    ...
                                    <div className="custom-control custom-checkbox pl-4 ml-3 pl-lg-0 ml-lg-0">
